...
var country_ip = '';
var ip_country = '';
var UrlPri2 = webAddress.match(/^dev/)?"stg1-":(webAddress.match(/^stg/))?"stg1-":"";
...
{   var jsonResult = $.parseJSON(jsonResult);
    ...
    {   
        ...
        invalidmsg_ctl(mob_box,jsonResult["message"],err_div);
...
//          p_nm = p_nm.charAt(0).toUpperCase() + p_nm.slice(1);
            ...
            {
             $('#identyfy_usr_ctl').css({"width":"720px"});
            ...
            success: function ( jsonResult ){
              ...
              if(jsonResult['code']==200){
                ...
                if(jsonResult["code"] == '204'){
                                ...
                                else{ //invalidMsgLogin("Something went wrong. Please try again in sometime!");
                                invalidmsg_ctl(mob_box,"Something went wrong. Please try again in sometime!",err_div);
                                    //_gaq.push(['_trackEvent','SignIn_204',username,modid, 0, true]);
                                }
                        }
...
function changePopUpInput(identifiedPopName,flag) 
{
    ...
    /*if(identifiedPopName=="")
    {
        ...
        if ( iso == arr[i] ){
            ...
            $('#identifiedForm #mbl_idn').css({"padding":"13px 17px 13px 46px"});
            if(glmodid == 'DIR'){
            ...
            else
            {
                ...
                if(typeof LWG_call != undefined && LWG_call == 1){
                    $('#mbl_idn').html('Enter your Mobile Number');
                }
            }
        ...
        { 
            ...
            document.getElementById("logintoidentify").disabled = false;
            $("#logintoidentify").css("background-color","#00a699");
            $('#countrySuggesterIdenPop dt span.value').css({"display":"inline-block","height":"30px","padding":"9px 4px 4px 3px"});
            ...
            $('#identifiedForm #mbl_idn').css({"padding":"13px 17px 13px 106px"});
    ...
    {*/
        ...
        else
        {
           ...
           fieldFlag = 1;
            ...
            $("#logintoidentify").css("background-color","#00a699");
            validmsg_ctl(mob_box,err_div,flag);
            $('#countrySuggesterIdenPop dt span.value').css({"display":"inline-block","height":"32px","padding":"7px 4px 4px 3px"});
            //$('#countrySuggesterIdenPop dt span.value').css("height", "30px");
            //$('#countrySuggesterIdenPop dt span.value').css("padding-top", "8px!important");
            if(glmodid == 'PRODDTL')
                $('#countrySuggesterIdenPop dt span.value').css("height", "28px");
